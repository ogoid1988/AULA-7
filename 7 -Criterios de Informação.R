...
ARMA21 <- arima(var_PIB, order = c(2,0,9))
ARMA22 <- arima(var_PIB, order = c(2,0,9))
ARMA23 <- arima(var_PIB, order = c(2,0,9))
ARMA24 <- arima(var_PIB, order = c(2,0,9))
ARMA25 <- arima(var_PIB, order = c(2,0,9))
ARMA26 <- arima(var_PIB, order = c(2,0,9))
ARMA27 <- arima(var_PIB, order = c(2,0,9))
ARMA28 <- arima(var_PIB, order = c(2,0,9))
